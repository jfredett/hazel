...
use super::san::SANConversionError;
...
mod tests {
    ...
    mod pgn {
        ...
        fn imports_from_pgn_with_no_variations_and_halts() {
            let pgn = PGN::load("../hazel-core/tests/fixtures/no-variations-and-halts.pgn").unwrap();
        ...
        fn imports_from_pgn_with_no_variations_and_halt() {
            let pgn = PGN::load("../hazel-core/tests/fixtures/no-variations-and-no-halt.pgn").unwrap();
        ...
        fn imports_from_pgn_with_variations_and_no_halt() {
            let pgn = PGN::load("../hazel-core/tests/fixtures/with-variations-no-halt.pgn").unwrap();
        ...
        fn imports_from_pgn_with_variations_and_halt() {
            let pgn = PGN::load("../hazel-core/tests/fixtures/with-variations-halts.pgn").unwrap();
        ...
        fn imports_from_pgn_with_nested_variations_and_no_halt() {
            let pgn = PGN::load("../hazel-core/tests/fixtures/with-nested-variations-no-halt.pgn").unwrap();
        ...
        fn imports_from_pgn_with_nested_variations_and_halt() {
            let pgn = PGN::load("../hazel-core/tests/fixtures/with-nested-variations-halts.pgn").unwrap();
