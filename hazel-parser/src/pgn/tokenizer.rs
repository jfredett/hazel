    ...
    mod tokenizer {
        ...
        mod tokenize {
            ...
            fn imports_from_pgn_with_no_variations_and_halt() {
                let (input, tokens) = PGNToken::tokenize_file("../hazel-core/tests/fixtures/no-variations-and-no-halt.pgn").unwrap();
                let expected = [
                    PGNToken::GameStart,
            ...
            fn imports_from_pgn_with_variations_and_no_halt() {
                let (input, tokens) = PGNToken::tokenize_file("../hazel-core/tests/fixtures/with-variations-no-halt.pgn").unwrap();
                let expected = [
                    PGNToken::GameStart,
            ...
            fn imports_from_pgn_with_variations_and_halt() {
                let (input, tokens) = PGNToken::tokenize_file("../hazel-core/tests/fixtures/with-variations-halts.pgn").unwrap();
                let expected = [
                    PGNToken::GameStart,
                    PGNToken::TagPair(TagPair { name: "Event".to_string(), value: "With Variations".to_string() }),
                    PGNToken::TagPair(TagPair { name: "White".to_string(), value: "white".to_string() }),
            ...
            fn imports_from_pgn_with_nested_variations_and_no_halt() {
                let (input, tokens) = PGNToken::tokenize_file("../hazel-core/tests/fixtures/with-nested-variations-no-halt.pgn").unwrap();
                let expected = [
                    PGNToken::GameStart,
            ...
            fn imports_from_pgn_with_nested_variations_and_halt() {
                let (input, tokens) = PGNToken::tokenize_file("../hazel-core/tests/fixtures/with-nested-variations-halts.pgn").unwrap();
                let expected = [
                    PGNToken::GameStart,
                    PGNToken::TagPair(TagPair { name: "Event".to_string(), value: "Nested Variations".to_string() }),
                    PGNToken::TagPair(TagPair { name: "White".to_string(), value: "white".to_string() }),
        ...
        fn imports_from_pgn_with_no_variations_and_halts() {
            let (input, tokens) = PGNToken::tokenize_file("../hazel-core/tests/fixtures/no-variations-and-halts.pgn").unwrap();
