...
lazy_static! {
    ...
    pub static ref POS2_KIWIPETE_MOVES : Vec<Move> = vec![
        ...
        Move::from_notation("a2", "a4", MoveType::QUIET),
        Move::from_notation("g2", "g4", MoveType::QUIET),
        ...
        Move::from_notation("e5", "g6", MoveType::QUIET),
        Move::from_notation("e5", "d7", MoveType::QUIET),
        Move::from_notation("e5", "f7", MoveType::QUIET),
    ...
    pub static ref STARTING_MOVES : Vec<Move> = vec![
        Move::from_notation("a2", "a4", MoveType::QUIET),
        Move::from_notation("a2", "a3", MoveType::QUIET),
        Move::from_notation("b2", "b4", MoveType::QUIET),
        Move::from_notation("b2", "b3", MoveType::QUIET),
        Move::from_notation("c2", "c4", MoveType::QUIET),
        Move::from_notation("c2", "c3", MoveType::QUIET),
        Move::from_notation("d2", "d4", MoveType::QUIET),
        Move::from_notation("d2", "d3", MoveType::QUIET),
        Move::from_notation("e2", "e4", MoveType::QUIET),
        Move::from_notation("e2", "e3", MoveType::QUIET),
        Move::from_notation("f2", "f4", MoveType::QUIET),
        Move::from_notation("f2", "f4", MoveType::QUIET),
        Move::from_notation("g2", "g4", MoveType::QUIET),
        Move::from_notation("g2", "g4", MoveType::QUIET),
    ...
    pub static ref D4_MOVES : Vec<Move> = vec![
        Move::from_notation("a7", "a5", MoveType::QUIET),
        Move::from_notation("a7", "a6", MoveType::QUIET),
        Move::from_notation("b7", "b5", MoveType::QUIET),
        Move::from_notation("b7", "b6", MoveType::QUIET),
        Move::from_notation("c7", "c5", MoveType::QUIET),
        Move::from_notation("c7", "c6", MoveType::QUIET),
        Move::from_notation("d7", "d5", MoveType::QUIET),
        Move::from_notation("d7", "d6", MoveType::QUIET),
        Move::from_notation("e7", "e5", MoveType::QUIET),
        Move::from_notation("e7", "e6", MoveType::QUIET),
        Move::from_notation("f7", "f5", MoveType::QUIET),
        Move::from_notation("f7", "f5", MoveType::QUIET),
        Move::from_notation("g7", "g5", MoveType::QUIET),
        Move::from_notation("g7", "g5", MoveType::QUIET),
