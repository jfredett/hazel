...
lazy_static! {
    ...
    pub static ref POS2_KIWIPETE_MOVES : Vec<Move> = vec![
        ...
        Move::from_notation("g2", "h3", Either::Left(MoveType::capture())),
        Move::from_notation("d5", "e6", Either::Left(MoveType::capture())),
        ...
        Move::from_notation("e2", "a6", Either::Left(MoveType::capture())),
        ...
        Move::from_notation("f3", "h3", Either::Left(MoveType::capture())),
        ...
        Move::from_notation("f3", "f6", Either::Left(MoveType::capture())),
