...
impl Metadata {
    pub fn en_passant(self) -> Option<Bitboard> {
        if self.has_en_passant {
            let ep_rank = if self.to_move.is_black() {
                *RANK_3
            } else {
                *RANK_6
            };
    ...
    pub fn half_move_tick(&mut self) {
        self.half_move_clock += 1;
    }
    pub fn half_move_untick(&mut self) {
        self.half_move_clock -= 1;
    }
    pub fn half_move_reset(&mut self) {
    ...
    pub fn full_move_reset(&mut self) {
