...
impl MoveType {
    ...
    #[inline(always)] pub fn is_long_castle(self)  -> bool { self == MoveType::LONG_CASTLE }
    #[inline(always)] pub fn is_short_castle(self) -> bool { self == MoveType::SHORT_CASTLE }
    #[inline(always)] pub fn is_capture(self)      -> bool { (self as u16 & Self::CAPTURE_MASK) != 0 }
    #[inline(always)] pub fn is_quiet(self)        -> bool { self == MoveType::QUIET }
    #[inline(always)] pub fn is_promotion(self)    -> bool { (self as u16 & Self::PROMOTION_MASK) != 0 }
